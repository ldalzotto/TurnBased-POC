...
namespace System.Collections.Generic
{
    ...
    public class RefDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
    {
        ...
        public RefDictionary() : this(0, null) { }

        public RefDictionary(int capacity) : this(capacity, null) { }

        public RefDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer) { }
        ...
        public RefDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public RefDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
        ...
        protected RefDictionary(SerializationInfo info, StreamingContext context)
        {
        ...
        public void AddRef(TKey key, ref TValue value)
        {
            InsertRef(key, ref value, true);
        }
        ...
        private void InsertRef(TKey key, ref TValue value, bool add)
        {
            ...
            IDictionaryEnumerator
        {
            ...
            internal Enumerator(RefDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(RefDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(RefDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
