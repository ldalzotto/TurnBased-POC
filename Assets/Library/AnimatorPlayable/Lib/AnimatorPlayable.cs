...
{
    public class AnimatorPlayable : IAnimatorPlayable
    {
        ...
        public static void free(AnimatorPlayable p_animatorPlayable)
        {
            p_animatorPlayable.GlobalPlayableGraph.Destroy();
        }
