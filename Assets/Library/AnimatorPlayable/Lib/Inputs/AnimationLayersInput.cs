...
namespace _AnimatorPlayable
{
    ...
    public struct LinearBlending
    {
        ...
        [ReadOnly]
        public float AnimationWeightStartIncreasingTime;
        [ReadOnly]
        public float AnimationWeightEndIncreasingTime;
    ...
    public class BlendedAnimationClip
    {
        ...
        [ReadOnly] public LinearBlending Blending;
        [ReadOnly] public int InputHandler;
